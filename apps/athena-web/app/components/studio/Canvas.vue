...
<template>
  ...
  >
    <div class="w-full max-w-3xl flex flex-col flex-1 relative">
        ...
        <div
          ...
          :class="[
            activeBlockId === block.id
              ? 'ring-1 ring-primary-500 bg-white dark:bg-gray-900 z-10 shadow-sm'
              : 'ring-1 ring-transparent hover:ring-gray-300 dark:hover:ring-gray-700'
          ]"
      ...
      <div class="sticky bottom-4 mt-auto flex justify-center z-20 pointer-events-none">
